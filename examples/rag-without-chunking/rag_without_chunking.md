...
This example demonstrates a knowledge base with chunking disabled, where each FAQ entry is embedded and retrieved as a whole.
...
- [The RAG with a custom chunker example](/learn/by-example/rag-with-custom-chunker/)
