...
Ballerina's MCP library allows you to create MCP servers that expose tools. An `mcp:StreamableHttpAdvancedService` service expects two remote methods, namely `onListTools` and `onCallTool`, to allow AI assistants to discover and call tools respectively.
