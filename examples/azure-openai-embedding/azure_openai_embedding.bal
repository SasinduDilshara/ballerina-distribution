...
final azure:EmbeddingProvider embedder =
    check new (serviceUrl, accessToken, apiVersion, deploymentId);
...
public function main() returns error? {
    ...
    ai:TextChunk ticketChunk = {
        content: "My invoice shows an incorrect billing amount."};
