...
This example demonstrates a complete RAG workflow using Milvus: ingesting a Markdown leave policy document into a Milvus collection and then answering a question about casual leave rules from the indexed content.
...
## Related links
- [Sample policy document](https://github.com/ballerina-platform/ballerina-distribution/tree/master/examples/rag-with-milvus/leave_policy.md)
